...
async function runTests() {
    try {
        ...
        const isVerified = await verifyUnlockHash(testText, unlockHash);
        ...
        const voucher = await createVoucher(testText, uniqueId);
        console.log('Created Voucher:', voucher);
        const decryptedVoucher = await decryptVoucher(voucher, uniqueId);
        ...
        try {
            await decryptVoucher('invalid-voucher', uniqueId);
